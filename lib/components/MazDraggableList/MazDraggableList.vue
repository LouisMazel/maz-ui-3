<template>
  ...
  >
    <Draggable v-model="items" v-bind="dragOptions" group="modules" @start="drag = true" @end="drag = false">
      <TransitionGroup type="transition" tag="div" :name="!drag ? 'maz-flip-list' : null">
        <div
