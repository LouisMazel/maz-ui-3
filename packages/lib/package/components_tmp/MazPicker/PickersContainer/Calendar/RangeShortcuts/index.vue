<template>
  <div
    ...
    class="range-shortcuts maz-direction-column maz-border-right maz-border-right-solid maz-flex maz-overflow-y-auto maz-border-color maz-px-2 maz-py-1"
  >
    <MazBtn
      ...
      class="shortcut-button maz-no-shadow maz-my-1 maz-flex-1 maz-bg-transparent"
