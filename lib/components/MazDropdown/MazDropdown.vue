<template>
  ...
  >
    <MazBtn no-shadow class="maz-dropdown__btn" :color="color" v-bind="$attrs" @focus="openMenu()" @blur="closeMenu()">
      <slot />
    ...
    <Transition tag="div" name="maz-fade" class="maz-bg-color">
      <div
        ...
        class="
          ...
          maz-flex maz-direction-column maz-border-radius maz-bg-color maz-border maz-border-solid maz-border-color
        "
        :class="[
          {
