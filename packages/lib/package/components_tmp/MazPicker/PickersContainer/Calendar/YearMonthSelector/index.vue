<template>
  <transition name="maz-slide">
    ...
    >
      <div class="maz-align-center maz-flex maz-justify-end">
        <div v-if="value === 'year'" class="maz-align-center maz-flex">
          <MazBtn
            fab
            no-shadow
            size="mini"
            color="grey"
            class="maz-hover-bg-color maz-no-focus-bg maz-mr-1 maz-flex maz-bg-transparent maz-flex-center"
            tabindex="-1"
        ...
        <MazBtn
          ...
          color="grey"
          tabindex="-1"
          class="year-month-selector__close maz-hover-bg-color maz-no-focus-bg maz-bg-transparent"
          @click="closePanel"
        >
          <i class="material-icons maz-fs-20 maz-text-color"> close </i>
        </MazBtn>
      </div>
      <div
        class="maz-space-between maz-align-center maz-flex maz-flex-1 maz-flex-wrap maz-pt-2"
      >
        <MazBtn
          v-for="(m, i) in months"
          :key="i"
          ...
          class="year-month-selector__btn maz-no-shadow maz-flex-20 maz-mx-1 maz-bg-transparent maz-px-3"
          tabindex="-1"
          @click="selectMonth(i)"
        >
          {{ m }}
        ...
        <MazBtn
          ...
          class="year-month-selector__btn maz-no-shadow maz-bg-transparent"
