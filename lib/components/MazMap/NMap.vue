...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    props: {
      ...
      center: { type: Object as PropType<MapOptions['center']>, required: true },
      zoom: { type: Number, default: 14 },
      markers: { type: Array as PropType<MapMarker[] | MapHTMLMarker[]>, default: null },
    },
    setup(props) {
        ...
        watch(
          ...
          async (markers) => {
            ...
            for await (const marker of markers) {
              ...
              isHtmlMarker ? map.addHTMLMarker(marker as MapHTMLMarker) : map.addMarker(marker as MapMarker)
            }
