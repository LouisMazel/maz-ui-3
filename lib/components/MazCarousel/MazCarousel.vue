<template>
  <div class="m-carousel maz-flex maz-flex-col">
    <div v-if="hasHeader()" class="m-carousel__header maz-flex maz-items-center">
      <!-- Title of the carousel -->
      <slot name="title" />
      <div v-if="scrollBtn" class="m-carousel__header__actions maz-flex maz-flex-1 maz-justify-end maz-space-x-2">
        <MazBtn
          color="transparent"
