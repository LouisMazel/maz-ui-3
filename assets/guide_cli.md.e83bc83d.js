import{_ as l,c as p,k as s,a as o,t as a,Q as e,o as t}from"./chunks/framework.02bfe7fb.js";const m=JSON.parse('{"title":"@mazui/cli","description":"CLI of maz-ui to generate CSS variables file to theming maz-ui","frontmatter":{"title":"@mazui/cli","description":"CLI of maz-ui to generate CSS variables file to theming maz-ui"},"headers":[],"relativePath":"guide/cli.md","filePath":"guide/cli.md","lastUpdated":1699549989000}'),c={name:"guide/cli.md"},r={id:"frontmatter-title",tabindex:"-1"},E=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{ $frontmatter.title }}"'},"​",-1),y=e(`<h2 id="config-file" tabindex="-1">Config file <a class="header-anchor" href="#config-file" aria-label="Permalink to &quot;Config file&quot;">​</a></h2><p>Then, in your root folder of your project, add a file named <code>maz-ui.config.{ts, js, mjs, cjs}</code> as bellow (<a href="#maz-ui-configuration-file-typescript-interface">model</a>)</p><p>All colors can be in HEX, RGB, RGBA, HSL, HSLA and named formats.</p><p>No theme variables are required, you can put only one if you wish</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { defineConfig } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;@mazui/cli&#39;</span></span>
