import{d as m,h as v,D as u,c as B,k as a,a as h,t as p,I as r,w as d,R as o,o as E,b as F,e as q,n as g}from"./chunks/framework.W8l_Wv3U.js";const C={id:"frontmatter-title",tabindex:"-1"},f=a("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{ $frontmatter.title }}"'},"​",-1),b=o('<div class="info custom-block"><p class="custom-block-title">INFO</p><p>Before you have to import the global css files in your project, follow instructions in <a href="./../guide/getting-started">Getting Started</a></p></div><h2 id="basic-usage" tabindex="-1">Basic usage <a class="header-anchor" href="#basic-usage" aria-label="Permalink to &quot;Basic usage&quot;">​</a></h2><p>Select a competition</p>',3),_=o(`<div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">  ]</span></span>
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">script</span><span style="color:#24292E;">&gt;</span></span></code></pre></div></details><h2 id="props-event-slots" tabindex="-1">Props, Event &amp; Slots <a class="header-anchor" href="#props-event-slots" aria-label="Permalink to &quot;Props, Event &amp; Slots&quot;">​</a></h2><h3 id="props" tabindex="-1">Props <a class="header-anchor" href="#props" aria-label="Permalink to &quot;Props&quot;">​</a></h3><table><thead><tr><th>Prop name</th><th>Description</th><th>Type</th><th>Values</th><th>Default</th></tr></thead><tbody><tr><td>modelValue</td><td></td><td>string|number</td><td>-</td><td>undefined</td></tr><tr><td>options</td><td></td><td>ButtonsRadioOption[]</td><td>-</td><td></td></tr><tr><td>name</td><td></td><td>HTMLInputElement[&#39;name&#39;]</td><td>-</td><td>&#39;MazButtonsRadio&#39;</td></tr><tr><td>color</td><td></td><td>Color</td><td>-</td><td>&#39;primary&#39;</td></tr><tr><td>noElevation</td><td></td><td>boolean</td><td>-</td><td>false</td></tr><tr><td>orientation</td><td></td><td>string</td><td><code>row</code>, <code>col</code></td><td>&#39;row&#39;</td></tr></tbody></table><h3 id="events" tabindex="-1">Events <a class="header-anchor" href="#events" aria-label="Permalink to &quot;Events&quot;">​</a></h3><table><thead><tr><th>Event name</th><th>Properties</th><th>Description</th></tr></thead><tbody><tr><td>update:model-value</td><td></td><td></td></tr><tr><td>change</td><td></td><td></td></tr></tbody></table><h3 id="slots" tabindex="-1">Slots <a class="header-anchor" href="#slots" aria-label="Permalink to &quot;Slots&quot;">​</a></h3><table><thead><tr><th>Name</th><th>Description</th><th>Bindings</th></tr></thead><tbody><tr><td>default</td><td></td><td><br></td></tr></tbody></table>`,8),M=JSON.parse('{"title":"MazRadioButtons","description":"MazRadioButtons is a standalone component to select a value in a list. Made with native HTMLInputElement type radio","frontmatter":{"title":"MazRadioButtons","description":"MazRadioButtons is a standalone component to select a value in a list. Made with native HTMLInputElement type radio"},"headers":[],"relativePath":"components/maz-radio-buttons.md","filePath":"components/maz-radio-buttons.md","lastUpdated":1700691354000}'),z={name:"components/maz-radio-buttons.md"},R=m({...z,setup(P){const n=v(),t=[{value:"1",label:"Ligue 1",areaName:"France",areaEnsignUrl:"https://upload.wikimedia.org/wikipedia/en/c/c3/Flag_of_France.svg"},{value:"2",label:"Premier League",areaName:"England",areaEnsignUrl:"https://crests.football-data.org/770.svg"},{value:"3",label:"Bundesliga",areaName:"Germany",areaEnsignUrl:"https://upload.wikimedia.org/wikipedia/commons/b/ba/Flag_of_Germany.svg"},{value:"4",label:"Eredivisie",areaName:"Netherlands",areaEnsignUrl:"https://upload.wikimedia.org/wikipedia/commons/2/20/Flag_of_the_Netherlands.svg"},{value:"5",label:"Serie A",areaName:"Italy",areaEnsignUrl:"https://upload.wikimedia.org/wikipedia/en/0/03/Flag_of_Italy.svg"},{value:"6",label:"Primera Division",areaName:"Spain",areaEnsignUrl:"https://upload.wikimedia.org/wikipedia/en/9/9a/Flag_of_Spain.svg"},{value:"7",label:"Primeira Liga",areaName:"Portugal",areaEnsignUrl:"https://upload.wikimedia.org/wikipedia/commons/5/5c/Flag_of_Portugal.svg"},{value:"8",label:"UEFA Champions League",areaName:"Europe",areaEnsignUrl:"https://crests.football-data.org/EUR.svg"}];return(y,l)=>{const e=u("MazRadioButtons",!0),i=u("MazAvatar");return E(),B("div",null,[a("h1",C,[h(p(y.$frontmatter.title)+" ",1),f]),a("p",null,p(y.$frontmatter.description),1),b,r(e,{modelValue:n.value,"onUpdate:modelValue":l[0]||(l[0]=s=>n.value=s),options:t},null,8,["modelValue"]),_,a("div",null,[r(e,{modelValue:n.value,"onUpdate:modelValue":l[1]||(l[1]=s=>n.value=s),options:t,color:"secondary"},{default:d(({option:s,selected:c})=>[a("div",k,[s.areaEnsignUrl?(E(),F(i,{key:0,src:s.areaEnsignUrl,style:{"margin-right":"16px"},size:"0.8rem"},null,8,["src"])):q("",!0),a("div",A,[a("span",null,p(s.label),1),a("span",{class:g({"maz-text-muted":!c})},p(s.areaName),3)])])]),_:1},8,["modelValue"])]),D,a("div",null,[r(e,{modelValue:n.value,"onUpdate:modelValue":l[2]||(l[2]=s=>n.value=s),options:t,orientation:"col"},{default:d(({option:s,selected:c})=>[a("div",w,[s.areaEnsignUrl?(E(),F(i,{key:0,src:s.areaEnsignUrl,style:{"margin-right":"16px"},size:"0.8rem"},null,8,["src"])):q("",!0),a("div",U,[a("span",null,p(s.label),1),a("span",{class:g({"maz-text-muted":!c})},p(s.areaName),3)])])]),_:1},8,["modelValue"])]),N])}}});export{M as __pageData,R as default};
