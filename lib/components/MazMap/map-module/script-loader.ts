...
export class ScriptLoader {
  ...
  constructor(private readonly apiKey: string, private readonly options?: ScriptOptions) {
    if (typeof window === 'undefined') throw new TypeError('[NMap ScriptLoader]: Map is supported only on browser side')
