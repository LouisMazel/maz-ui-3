import"./chunks/MazToast.vue_vue_type_style_index_1_scoped_27773562_lang.4ed993c7.js";import{a as d}from"./chunks/use-maz-dialog-promise.e7d99bc7.js";import{d as g,a4 as C,C as B,o as T,c as f,k as s,a as e,t as o,H as p,l as a,Q as k}from"./chunks/framework.02bfe7fb.js";const q={id:"frontmatter-title",tabindex:"-1"},D=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{ $frontmatter.title }}"'},"​",-1),z=s("h2",{id:"usage",tabindex:"-1"},[e("Usage "),s("a",{class:"header-anchor",href:"#usage","aria-label":'Permalink to "Usage"'},"​")],-1),A={class:"maz-flex maz-gap-4"},_={class:"maz-flex maz-flex-center maz-flex-col maz-text-center maz-gap-2"},b=s("span",null,"Dark",-1),v={class:"maz-flex maz-flex-center maz-flex-col maz-text-center maz-gap-2"},x=s("span",null,"Light",-1),w={class:"maz-flex maz-flex-center maz-flex-col maz-text-center maz-gap-2"},S=s("span",null,"System",-1),M={class:"maz-flex maz-flex-center maz-flex-col maz-text-center maz-gap-2"},L=s("span",null,"Toggle",-1),H=s("h3",{id:"data",tabindex:"-1"},[e("Data "),s("a",{class:"header-anchor",href:"#data","aria-label":'Permalink to "Data"'},"​")],-1),V=s("br",null,null,-1),P=k(`<h2 id="how-to-use-it" tabindex="-1">How to use it? <a class="header-anchor" href="#how-to-use-it" aria-label="Permalink to &quot;How to use it?&quot;">​</a></h2><div class="info custom-block"><p class="custom-block-title">INFO</p><p><code>autoSetTheme</code> method, does not store theme value in localStorage but always lets the user&#39;s preferences apply on every visit (some users automatically have light mode during the day and dark at night)</p></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>Always run <code>autoSetTheme</code> method on app initialization and let the user change the theme with <code>toggleTheme</code> or <code>setDarkTheme</code> or <code>setLightTheme</code></p></div><h3 id="example" tabindex="-1">Example <a class="header-anchor" href="#example" aria-label="Permalink to &quot;Example&quot;">​</a></h3><p><code>App.vue</code> or <code>layouts/default.vue</code></p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
