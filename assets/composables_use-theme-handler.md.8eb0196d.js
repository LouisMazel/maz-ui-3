import"./chunks/MazToast.vue_vue_type_style_index_1_scoped_27773562_lang.4ed993c7.js";import{a as g}from"./chunks/use-maz-dialog-promise.40f1dc5f.js";import{d as C,j as B,C as f,o as T,c as k,k as s,a as e,t as o,H as l,l as a,n as y,Q as q}from"./chunks/framework.02bfe7fb.js";const D={id:"frontmatter-title",tabindex:"-1"},z=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{ $frontmatter.title }}"'},"​",-1),A=s("h2",{id:"usage",tabindex:"-1"},[e("Usage "),s("a",{class:"header-anchor",href:"#usage","aria-label":'Permalink to "Usage"'},"​")],-1),_={class:"maz-flex maz-gap-4"},b={class:"maz-flex maz-flex-center maz-flex-col maz-text-center maz-gap-2"},v=s("span",null,"Dark",-1),x={class:"maz-flex maz-flex-center maz-flex-col maz-text-center maz-gap-2"},w=s("span",null,"Light",-1),S={class:"maz-flex maz-flex-center maz-flex-col maz-text-center maz-gap-2"},M=s("span",null,"System",-1),L={class:"maz-flex maz-flex-center maz-flex-col maz-text-center maz-gap-2"},H=s("span",null,"Toggle",-1),V=s("h3",{id:"data",tabindex:"-1"},[e("Data "),s("a",{class:"header-anchor",href:"#data","aria-label":'Permalink to "Data"'},"​")],-1),P=s("br",null,null,-1),N=q(`<h2 id="how-to-use-it" tabindex="-1">How to use it? <a class="header-anchor" href="#how-to-use-it" aria-label="Permalink to &quot;How to use it?&quot;">​</a></h2><div class="info custom-block"><p class="custom-block-title">INFO</p><p><code>autoSetTheme</code> method, does not store theme value in localStorage but always lets the user&#39;s preferences apply on every visit (some users automatically have light mode during the day and dark at night)</p></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>Always run <code>autoSetTheme</code> method on app initialization and let the user change the theme with <code>toggleTheme</code> or <code>setDarkTheme</code> or <code>setLightTheme</code></p></div><h3 id="example" tabindex="-1">Example <a class="header-anchor" href="#example" aria-label="Permalink to &quot;Example&quot;">​</a></h3><p><code>App.vue</code> or <code>layouts/default.vue</code></p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
...
<span class="line"><span style="color:#24292E;">  })</span></span>
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">script</span><span style="color:#24292E;">&gt;</span></span></code></pre></div>`,6),J=JSON.parse('{"title":"useThemeHandler","description":"Vue composable for handling UI theme - Automatically sets dark and light theme and switches between them","frontmatter":{"title":"useThemeHandler","description":"Vue composable for handling UI theme - Automatically sets dark and light theme and switches between them"},"headers":[],"relativePath":"composables/use-theme-handler.md","filePath":"composables/use-theme-handler.md","lastUpdated":1699315151000}'),O={name:"composables/use-theme-handler.md"},Q=C({...O,setup(U){const i={darkClass:"dark",lightClass:"light",storageThemeKey:"theme",storageThemeValueDark:"dark",storageThemeValueLight:"light",storageThemeValueSystem:"system"},{autoSetTheme:h,toggleTheme:m,setDarkTheme:u,setLightTheme:F,setSystemTheme:d,theme:p,hasDarkTheme:t,hasLightTheme:c,hasSystemTheme:r,internalTheme:I}=g(i);return B(()=>{h()}),(E,K)=>{const n=f("MazBtn");return T(),k("div",null,[s("h1",D,[e(o(E.$frontmatter.title)+" ",1),z]),s("p",null,o(E.$frontmatter.description),1),A,s("div",_,[s("div",b,[v,l(n,{icon:"moon",fab:"",color:a(t)?"secondary":"primary",class:y(a(p)==="dark"?"!maz-outline !maz-outline-offset-2 !maz-outline-secondary":""),size:"lg",onClick:a(u)},null,8,["color","class","onClick"])]),s("div",x,[w,l(n,{icon:"sun",fab:"",color:a(c)?"secondary":"primary",class:y(a(p)==="light"?"!maz-outline !maz-outline-offset-2 !maz-outline-secondary":""),size:"lg",onClick:a(F)},null,8,["color","class","onClick"])]),s("div",S,[M,l(n,{icon:"computer-desktop",fab:"",color:a(r)?"secondary":"primary",size:"lg",onClick:a(d)},null,8,["color","onClick"])]),s("div",L,[H,l(n,{icon:"arrow-path",fab:"",size:"lg",onClick:a(m)},null,8,["onClick"])])]),V,P,s("code",null,o({theme:a(p),hasDarkTheme:a(t),hasLightTheme:a(c),hasSystemTheme:a(r)}),1),N])}}});export{J as __pageData,Q as default};
